document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        ar: {
            ...
            howItWorksSubtitle: 'نعمل عملية تعاون مدروسة بدقة لضمان نتائج حقيقية وفاعلة.',
            step1Title: 'المرحلة 1: البحث ',
            step1Desc: 'أدرس نشاطك، أهدافك، وجمهورك بدقة لفهم احتياجاتك الحقيقية.',
            step2Title: 'المرحلة 2: التخطيط',
            step2Desc: 'أضع استراتيجية واضحة وتوجهاً إبداعياً يعكس هوية علامتك بتميّز.',
            step3Title: 'المرحلة 3: التصميم',
            step3Desc: 'أحوّل الأفكار إلى هوية بصرية متكاملة وذات أثر طويل الأمد.',
            step4Title: 'المرحلة 4: التسليم',
            step4Desc: 'أقدّم الملفات النهائية مع إرشادات ودعم لضمان نجاح علامتك بثقة.',
        ...
        en: {
            ...
            step3Desc: 'I turn ideas into a cohesive and lasting visual identity.',
            step4Title: 'Phase 4: Delivery',
            step4Desc: 'I deliver the final files and provide support to ensure a confident start.',
        ...
        fr: {
            ...
            howItWorksTitle: 'Notre Méthode de Travail',
            howItWorksSubtitle: 'Un processus de collaboration soigneusement conçu pour garantir des résultats réels et efficaces.',
            step1Title: 'Phase 1 : Recherche & Analyse',
            step1Desc: 'J’étudie votre activité, vos objectifs et votre audience afin de comprendre vos besoins réels',
            step2Title: 'Phase 2 : Planification',
            step2Desc: 'Je définis une stratégie claire et une direction créative qui reflètent l’identité unique de votre marque.',
            step3Title: 'Phase 3 : Design',
            step3Desc: 'Je transforme les idées en une identité visuelle cohérente et durable.',
            step4Title: 'Phase 4: Livraison',
            step4Desc: 'Je vous fournis les livrables finaux ainsi qu’un accompagnement pour assurer un démarrage réussi et confiant.',

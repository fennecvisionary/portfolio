document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        ar: {
            ...
            step1Desc: 'فهم عملك وأهدافك وجمهورك بوضوح.',
            step2Title: 'الخطوة 2 : التحديد',
            step2Desc: 'وضع الاستراتيجية والتوجه الإبداعي لعلامتك.',
            step3Title: 'الخطوة 3 : التصميم',
            step3Desc: 'تحويل الرؤية إلى هوية بصرية قوية ودائمة.',
            step4Title: 'الخطوة 4 : التسليم',
            step4Desc: 'تسليم الملفات النهائية مع إرشادات ودعم لانطلاقة واثقة.',
        ...
        en: {
            ...
            step1Desc: 'Understand your business, goals, and audience with clarity.',
            step2Title: 'Step 2 : Define',
            step2Desc: 'Shape the strategy and creative direction of your brand.',
            step3Title: 'Step 3: Design',
            step3Desc: 'Bring the vision to life with a strong, lasting visual identity.',
            step4Title: 'Step 4 : Deliver',
            step4Desc: 'Provide the final files with guidelines and support for a confident launch.',
        ...
        fr: {
            ...
            step1Desc: 'Comprendre clairement votre activité, vos objectifs et votre public',
            step2Title: 'Étape 2 : Définir',
            step2Desc: 'Établir la stratégie et l’orientation créative de votre marque.',
            step3Title: 'Étape 3 : Concevoir',
            step3Desc: 'Donner vie à la vision avec une identité visuelle durable.',

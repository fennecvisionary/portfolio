document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        ...
        fr: {
            ...
            howItWorksSubtitle: 'Un processus de collaboration étudié pour assurer des résultats concrets et efficaces.',
            step1Title: 'Phase 1 : Recherche',
            ...
            step2Desc: 'Je crée une stratégie claire et une direction créative fidèles à l’identité de votre marque.',
            step3Title: 'Phase 3 : Design',
            step3Desc: 'Je transforme les idées en une identité visuelle cohérente et durable.',
            step4Title: 'Phase 4: Livraison',
            step4Desc: 'Je vous livre les livrables finaux avec un accompagnement pour un démarrage réussi et confiant.',
